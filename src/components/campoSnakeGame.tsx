...
export default function Campo() {
  ...
  return (
    <div className="flex flex-col justify-center items-center h-screen bg-green-800 ">
      <div className="w-[340px] bg-green-950 flex items-center ">
        <svg
