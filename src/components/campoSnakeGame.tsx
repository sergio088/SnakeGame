...
export default function Campo() {
  ...
  const [fases, setFase] = useState(false);
  const fasesRef = useRef(false);
  ...
  return (
    <div className="flex  justify-center items-center h-screen bg-green-800">
      {isOpen && (
        <div className={`fixed w-[340px] h-[340px] bg-black/40`}>
          <div className="flex flex-col justify-center items-center h-[300px] space-y-5">
            <div className="flex  justify-center items-center space-x-3">
              ...
              <p className="text-white text-4xl ">{quantM}</p>
            </div>
            ...
            <div className="flex space-x-5 ">
              <button
                ...
                className="text-white text-3xl border border-transparent bg-blue-950 hover:scale-110 transition-transform duration-300 shadow-2xl px-8 py-2 rounded "
              >
                Jogar
              </button>
            </div>
